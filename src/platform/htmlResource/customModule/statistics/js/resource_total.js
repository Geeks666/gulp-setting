...
require(['customConf'], function (configpaths) {
  ...
  define('', ['jquery', 'service', 'tools', 'common','dataResource/resourceTotalData.js'],
    function ($, service, tools, common,resourceTotalData) {
      ...
      var result = resourceTotalData.resourceCountData;
      // 平台资源统计
      ...
      function resourceTotolFetchData(scope, phaseid, type, domId) {
        ...
        var result = resourceTotalData.resourceTotalData;
      ...
      function resourceTrandFetchData(scope, time) {
        ...
        var result = resourceTotalData.resourceTendencyData;
      ...
      function resourceUseFetchData(scope) {
        var result = resourceTotalData.resourceUseData;
