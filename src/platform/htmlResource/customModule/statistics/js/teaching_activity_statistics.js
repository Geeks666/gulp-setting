...
require(['customConf'], function (configpaths) {
  ...
  define('', ['jquery', 'service', 'common', 'select','dataResource/teachingActivityStatisticsData.js'],
    function ($, service, common, select,teachingActivityStatisticsData) {
      ...
      function fqActivityNum(time, phaseId, subjectId, gradeId, schoolYear) {
        ...
        if (common.role == 'city') {
          ...
          result = teachingActivityStatisticsData.areaTotalIssueAreaData;
      ...
      function cyActivityNum(time, phaseId, subjectId, gradeId, schoolYear) {
        ...
        if (common.role == 'city') {
          ...
          result = teachingActivityStatisticsData.areaTotalJoinData;
        } else if (common.role == 'school') {
