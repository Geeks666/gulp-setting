...
require(['customConf'], function (configpaths) {
  ...
  define('', ['jquery', 'service', 'tools', 'common', 'paging' , 'dataResource/userAreaData.js'],
    function ($, service, tools, common, Paging,userAreaData) {
     ...
     /* echart_userarea_map.on('click', function (param) {
      ...
      function areaCountFetchData() {
        var result = userAreaData.areaCountData;
      ...
      function mapFetchData(areaname) {
        ...
        var result = userAreaData.areaDistribute;
      ...
      function areaFetchData(type, isfirst, time, domId, pageNo) {
        ...
        var result = userAreaData.areaUsedData;
        if (result['code'] == 200) {
          if (result['data']['length'] === 0) {
      ...
      * */
      function schoolFetchData(pageNo) {
        var extra = '';
        if (pageNo) extra = '&pageNo=' + pageNo;
        var result = userAreaData.schoolRankingData;
