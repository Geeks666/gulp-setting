...
require(['platformConf'], function (configpaths) {
  ...
  require(['jquery', 'tools', 'webuploader', 'header', 'footer', 'service', /*'uploadPers', */'layer', 'template'],
    function ($, tools, WebUploader, header, footer, service, /*uploadPers,*/ layer, template) {
